 ...
 * @param {object} stationModule the resposne of a require
 * @returns {array} Stations found in the object
 */
export const parseStationByType = (stationModule = {}) => {
  ...
  switch (true) {
    case stationConstructor === Object: {
      parsedStations.push(...parseStationObject(stationModule));
      break;
    }

    case stationConstructor === Array: {
