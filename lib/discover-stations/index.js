...
const log = debug('takeoff:discover-stations');
const logError = debug('takeoff:discover-stations:error');
 ...
 */
export const discoverStationsByPath = async path => {
  const foundStations = [];
...
const DiscoverStation = async ({
  ...
  for (const path of paths) {
    ...
    const foundStations = await discoverStationsByPath(stationPath);
...
export default DiscoverStation;
